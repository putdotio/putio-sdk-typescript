...
const AccountSettingsFields = {
  ...
  product_analytics_enabled: Schema.Boolean,
...
const AccountSettingsPatchFields = {
  ...
  diagnostics_enabled: Schema.optional(AccountSettingsFields.diagnostics_enabled),
  ...
  product_analytics_enabled: Schema.optional(AccountSettingsFields.product_analytics_enabled),
